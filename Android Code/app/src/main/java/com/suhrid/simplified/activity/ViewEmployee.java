...
public class ViewEmployee extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentOfView(R.layout.activity_viewemployee,this);
    ...
    private void getdeatils() {
        ...
        showDialog();
        data.clear();
        StringRequest strReq = new StringRequest("http://suhrid1theinceptor.000webhostapp.com/userlogin/employee_list_api.php", new Response.Listener<String>() {
                ...
                try {
                    ...
                    for (i = 0; i < data1.length(); i++) {
                        try {
                            ...
                            String e_name = json.getString("ename");
                            data.add(e_name);
                    ...
                    ViewEmployee.ProductAdapter adapter = new ViewEmployee.ProductAdapter(ViewEmployee.this, data);
    ...
    private String getphn(int position) {
        String name = "";
        try {
            //Getting object of given index
            JSONObject json = data1.getJSONObject(position);
    ...
    public class ProductAdapter extends RecyclerView.Adapter<ViewEmployee.ProductAdapter.ProductViewHolder> {
        ...
        @Override
        public ViewEmployee.ProductAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            //inflating and returning our view holder
            LayoutInflater inflater = LayoutInflater.from(mCtx);
            View view = inflater.inflate(R.layout.list_item3, null);
            return new ViewEmployee.ProductAdapter.ProductViewHolder(view);
        }

        @Override
        public void onBindViewHolder(ViewEmployee.ProductAdapter.ProductViewHolder holder, final int position) {
            ...
            holder.textViewTitle.setText(
                    content);
             holder.textViewShortDesc.setText(getemail(position));
            // holder.textViewRating.setText(String.valueOf(product.getRating()));
             holder.textViewPrice.setText(getphn(position));
            Linkify.addLinks(holder.textViewPrice, Linkify.PHONE_NUMBERS );
            holder.textViewTitle.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(getApplicationContext(), "Details for " + getid(position), Toast.LENGTH_LONG).show();

                   /* Intent i = new Intent(ViewEmployee.this, CompanyDetails.class);
