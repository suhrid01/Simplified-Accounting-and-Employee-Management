...
public class ViewCustomer extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentOfView(R.layout.activity_view_customer,this);
    ...
    private void getdeatils() {
        ...
        showDialog();
        data.clear();
        StringRequest strReq = new StringRequest("http://suhrid1theinceptor.000webhostapp.com/userlogin/customer_details_api.php", new Response.Listener<String>() {
                ...
                try {
                    ...
                    for (i = 0; i < data1.length(); i++) {
                        try {
                            ...
                            String e_name = json.getString("customername");
                            data.add(e_name);
                    ...
                    ViewCustomer.ProductAdapter adapter = new ViewCustomer.ProductAdapter(ViewCustomer.this, data);
    ...
    private String getphone(int position) {
        String name = "";
        try {
            //Getting object of given index
            JSONObject json = data1.getJSONObject(position);
    ...
    public class ProductAdapter extends RecyclerView.Adapter<ViewCustomer.ProductAdapter.ProductViewHolder> {
        ...
        @Override
        public ViewCustomer.ProductAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            //inflating and returning our view holder
            LayoutInflater inflater = LayoutInflater.from(mCtx);
            View view = inflater.inflate(R.layout.list_item, null);
            return new ViewCustomer.ProductAdapter.ProductViewHolder(view);
        }

        @Override
        public void onBindViewHolder(ViewCustomer.ProductAdapter.ProductViewHolder holder, final int position) {
            ...
            // holder.textViewRating.setText(String.valueOf(product.getRating()));
             holder.textViewPrice.setText("Contact: "+ getphone(position));
            holder.textViewTitle.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(getApplicationContext(), "Details for " + getname(position), Toast.LENGTH_LONG).show();

                   /* Intent i = new Intent(ViewCustomer.this, CompanyDetails.class);
