...
public class RemoveCompany extends BaseActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentOfView(R.layout.activity_remove_company,RemoveCompany.this);
...
//Initializing the ArrayList
                ...
                try {
                    ...
                    for (int i = 0; i < data1.length(); i++) {
                        try {
                            ...
                            eidlist.add(json.getString("customername"));
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(RemoveCompany.this,
    ...
    private void RemoveCompany(final String eid) {
        ...
        showDialog();
        String url = "http://suhrid1theinceptor.000webhostapp.com/userlogin/remove_company_api.php";
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                hideDialog();
                Toast.makeText(getApplicationContext(),
                        "Removed successfully "+ eid, Toast.LENGTH_LONG).show();
            }
        }, new Response.ErrorListener() {
