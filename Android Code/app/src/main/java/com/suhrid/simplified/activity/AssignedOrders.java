...
public class AssignedOrders extends BaseActivity   {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentOfView(R.layout.activity_assignedorders,this);
    ...
    private void getdeatils() {
        ...
        pDialog.setMessage("Fetching Assigned Orders...");
        showDialog();
        data.clear();
        StringRequest strReq = new StringRequest("http://suhrid1theinceptor.000webhostapp.com/userlogin/assigned_orders_api.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    AssignedOrders.ProductAdapter adapter = new AssignedOrders.ProductAdapter(AssignedOrders.this, data);
    ...
    private String getcust_name(int position) {
        ...
        try {
            ...
            //Fetching name from that object
            cid = json.getString("customername");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        //Returning the name
    ...
    public class ProductAdapter extends RecyclerView.Adapter<AssignedOrders.ProductAdapter.ProductViewHolder> {
        ...
        @Override
        public AssignedOrders.ProductAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            //inflating and returning our view holder
            LayoutInflater inflater = LayoutInflater.from(mCtx);
            View view = inflater.inflate(R.layout.list_item, null);
            return new AssignedOrders.ProductAdapter.ProductViewHolder(view);
        }

        @Override
        public void onBindViewHolder(AssignedOrders.ProductAdapter.ProductViewHolder holder, final int position) {
            ...
            holder.textViewTitle.setText(
                    content);
             holder.textViewShortDesc.setText("Employee Assigned: "+  getemp_id(position));
            // holder.textViewRating.setText(String.valueOf(product.getRating()));
             holder.textViewPrice.setText("Amount: "+ getamount(position));
            holder.textViewTitle.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(getApplicationContext(), "Change Orders for " + getid(position), Toast.LENGTH_LONG).show();


                    Intent i = new Intent(AssignedOrders.this, AssignOrder.class);
